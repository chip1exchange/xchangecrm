 ...
 * @param Smarty
 */
function smarty_function_sugar_xutility($params, &$smarty)
{
	$myRung = array("Broker"  => "c7fab8", "Pref. Broker" => "c7fab8", "CEM" => "c3daff", "OCM" => "c3daff", "OEM" => "c3daff", "Pref. IND" => "f0c0fb", "IND" => "f0c0fb", "Recy House" => "eeedc1", "Company Misc" => "8ac3d7", "FD" => "fddca9");
	return  $myRung[$params['prams']];
}
