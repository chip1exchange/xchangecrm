    ...
    function testtest($aa){return "done";}               
                {/php}
...
{if $hideTable == false}
    ...
    <tr>
                <td style="text-align:center" colspan="4"  class='td_alt'>&nbsp;</td>
                <td style="text-align:center; background:#dae5c4;"  colspan="7"  >Customer</td>
                <td style="text-align:center; background:#dae5c4"  colspan="7"  >Supplier</td>
    </tr>
	<tr height='20'>
			{if $prerow}
